              ...
              <> 
                ...
                <main>
                    ...
                    <div className={style.trailer}>
                        <div className={style.trailer_head}>
                            <a className={style.menu}>예고편</a>
                            <div className={style.trailer_button}>
                    ...
                    <div className={style.genre}>
                        <div className={style.genre_head}>
                            <a className={style.menu}>장르별 영화</a>
